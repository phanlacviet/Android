...
namespace K22CNT2_PhanLacViet_2210900079_project2.Areas.QuanTri.Controllers
{
    public class CTDHsController : Controller
    {
        ...
        // POST: QuanTri/CTDHs/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "STT,MaDH,MaSp,TenSP,GiaCa,Soluong")] CTDH cTDH)
        {
        ...
        // POST: QuanTri/CTDHs/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "STT,MaDH,MaSp,TenSP,GiaCa,Soluong")] CTDH cTDH)
        {
            if (ModelState.IsValid)
            {
